...
import 'package:harvest_lync/screens/authentication/otp_screen.dart';
  ...
  Future<void> verifyPhoneNumber(BuildContext context, number) async {
    ...
    try{
      auth.verifyPhoneNumber(phoneNumber: number,
          verificationCompleted: verificationCompleted, verificationFailed: verificationFailed, codeSent: codeSent,
